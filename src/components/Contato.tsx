...
export default function Contato() {
    return (
        <div id="contato" className="h-full lg:h-screen flex flex-col lg:flex-row items-center justify-center px-8 lg:px-64 gap-12 lg:gap-32 bg-cover bg-center" style={{ backgroundImage: "url('/bg3.png')" }}>
